/* ============================================================
   ...
   TEK Write ile yeni dosyaya yazildi. upsertUnits. Metin ozgun.
   ============================================================ */
(function () {
  if (typeof TYT_CONTENT === "undefined") { console.error("fen-konu-biyoloji-b: content-loader yuklenmedi"); return; }
  ...
  setUnit("biy-madde", "Hucre Zarindan Madde Gecisleri",
    ...
    "<p><b>Cozelti cesitleri:</b> Hipotonik ortamda hucre su alir (sisme); hipertonik ortamda su verir (buzusme, plazmoliz); izotonikte denge.</p>" +
  ...
  setUnit("biy-virus", "Virusler",
    ...
    "<p>Bu yuzden virusler <b>alemler icinde siniflandirilmaz</b>. Grip, kizamik gibi hastaliklara yol acar; antibiyotikler viruslere etki etmez.</p>",
  ...
  setUnit("biy-mitoz", "Mitoz ve Hucre Dongusu",
    ...
    "<h3>Sitokinez</h3><p>Sitoplazma bolunmesi. Hayvan hucresinde <b>bogumlanma</b>, bitki hucresinde <b>ara lamel</b> ile gerceklesir.</p>" +
  ...
  setUnit("biy-eseysiz", "Eseysiz Ureme",
    ...
    "<p><b>Eseysiz uremede</b> tek bir ata canliden, <b>mitozla</b>, ana canliyla <b>genetik olarak ayni</b> yavrular olusur (kalitsal cesitlilik <b>yoktur</b>). Hizlidir, kararli ortamlarda avantajlidir.</p>" +
    "<h3>Cesitleri</h3><ul>" +
  ...
  setUnit("biy-mayoz", "Mayoz ve Eseyli Ureme",
    ...
    "<p>Bu cesitlilik <b>eseyli ureme</b> ile birlesir: iki gametin <b>dollenme</b> ile birlesmesi kromozom sayisini yeniden <b>2n</b> yapar. Eseyli ureme <b>kalitsal cesitlilik</b> saglar; ortama uyumu artirir.</p>",
  ...
  setUnit("biy-ekosistem", "Ekosistem Ekolojisi ve Cevre",
    ...
    "<h3>Enerji akisi ve piramit</h3><p>Enerji <b>tek yonlu</b> akar (Gunes, uretici, tuketici sirasiyla) ve her basamakta buyuk kismi <b>isi olarak kaybolur</b> (yaklasik %10 aktarilir). Bu yuzden ust basamaklarda enerji ve birey sayisi azalir.</p>" +
    ...
    [{ term: "Uretici", def: "Fotosentezle enerji sokar" }, { term: "Enerji akisi", def: "Tek yonlu, azalir" }, { term: "Madde dongusu", def: "Su/karbon/azot tekrar kullanilir" }]);
